<template>
  ...
  <div class="login-container">
    ...
    <div class="login-inner-box">
           ...
           <h3 class="animate" style="opacity: 1; transform: translateY(0px);color:#fff;
          margin: 15px 0 8px;line-height: 1em;font-size: 180%;font-weight: normal;">
           
          </h3>
       <canvas id="root" width="1000" height="560" class="art-canvas"></canvas>
           <div class="login-form" style="top:45%">
